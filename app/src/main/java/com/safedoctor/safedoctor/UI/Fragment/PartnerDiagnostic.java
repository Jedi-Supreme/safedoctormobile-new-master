 ...
 */
public class PartnerDiagnostic extends Fragment {
...
//    private SafeDoctorService mSafeDoctorService;
    ...
    public static Fragment newInstance() {
        PartnerDiagnostic fragment = new PartnerDiagnostic();
        return  fragment;
    }

    public PartnerDiagnostic() {
...
//        common.getFacilities(hospitalRecyclerView);
        ...
        return inflater.inflate(R.layout.fragment_partner_diagnostic, container, false);
    }
