...
public class ContactPersons extends Fragment implements OnTaskCompleted
{
    ...
    {
        root = inflater.inflate(R.layout.fragment_contactpersons, container, false);
    ...
    public static ContactPersons newInstance()
    {
        ContactPersons  contactperson = new ContactPersons();
    ...
    private void initComponent()
    {
        ...
        txt_no_item = (TextView) root.findViewById(R.id.txt_no_item);
         ...
         items = AppConstants.CACHE_CONTACT_PERSONS;
        ...
        mAdapter.setOnClickListener(new ContactPersonsAdapter.OnClickListener() {
            ...
            public void onItemClick(View view, Patientcontactperson person, int pos) {
                ...
                {
                    //Patientcontactperson contactperson = mAdapter.getItem(pos);
    ...
    private void deleteInboxes() {
        ...
        for (int i = selectedItemPositions.size() - 1; i >= 0; i--)
        {
            ...
            Call<SwagArrayResponseModel> call = mSafeDoctorService.deleteContactPerson(TokenString.tokenString,AppConstants.patientID, p.getId());
    ...
    private void showCustomDialog(final Integer pos, final Patientcontactperson person, final boolean addmode)
    {
        ...
        if(!addmode && null != person) //view mode :will not allow changing
        {
            ...
            lblinfo.setText("View contact person");
        ...
        editdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lblinfo.setText("Edit contact person");
        ...
        ((AppCompatButton) dialog.findViewById(R.id.bt_submit)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(addmode) // post
                {
                    ...
                    Call<SwagArrayResponseModel<List<Patientcontactperson>>> call = mSafeDoctorService.saveContactPersons(TokenString.tokenString,AppConstants.patientID, person);
                ...
                else //put
                {
                    ...
                    Call<SwagArrayResponseModel<List<Patientcontactperson>>> call = mSafeDoctorService.updateContactPersons(TokenString.tokenString,AppConstants.patientID, person);
                ...
                //Toast.makeText(parentactivity.getApplicationContext(), "Submitted", Toast.LENGTH_SHORT).show();
            }
        });
