...
public class DeviceData  {
	...
	public static void printDatas ()
	{
		for (int i = 0; i < m_deviceDataList.size(); i++) {
			...
			Log.i("com.testbluetooth", "Datetime"+_DeviceData.m_iYear+"-"+_DeviceData.m_iMonth+"-"+_DeviceData.m_iDay
					+" "+_DeviceData.m_iHour+":00");
			Log.i("com.testbluetooth","M_SYS"+_DeviceData.m_nSys+"M_DIA"+_DeviceData.m_nDia+"MMAP"+_DeviceData.m_nMap );
		}
	}
}
