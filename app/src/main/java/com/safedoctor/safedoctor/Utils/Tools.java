...
public class Tools {
    ...
    public static Bitmap convertToBitmap(String base64string)
    {
       ...
       //return BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.length);
        ...
        return decodeSampledBitmapFromResource(imageBytes,100,100);
    }
    ...
    public static void displayImage(final Context ctx, final ImageView img, String base64string) {
        ...
        {
            byte[] imageBytes = Base64.decode(base64string, Base64.DEFAULT);
            Glide.with(ctx).load(imageBytes).asBitmap().centerCrop().into(new BitmapImageViewTarget(img) {
                @Override
                protected void setResource(Bitmap resource) {
                    RoundedBitmapDrawable circularBitmapDrawable = RoundedBitmapDrawableFactory.create(ctx.getResources(), resource);
                    circularBitmapDrawable.setCircular(true);
    ...
    public static void displayImageRound(final Context ctx, final ImageView img, String base64string) {
    ...
    public static void getURLThumbnail(Context ctx, ImageView img, String url) {
        try {
